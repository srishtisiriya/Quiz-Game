...
questions = ["Which of the following is a programming language?","Which programming paradigm emphasizes on writing code that is easy to read and maintain?","What is the term used for a block of code that is executed repeatedly until a certain condition is met?","Which data structure is used for storing a collection of elements in a non-linear fashion?","Which operator is used for exponentiation in most programming languages?"]
options = [['A. Python','B.  Photoshop','C. Microsoft Word','D. Adobe Illustrator','A. Python'],['A.Procedural programming','B.Object-oriented programming','C. Functional programming','D. 1981','B.Object-oriented programming'],
           ['A. Function','B. Loop','C. Condition','D. Variable','B. Loop'],['A.Array','B.Stack','C. Queue','D.Tree','D.Tree'],['A. ^','B. ','C.  %','D. *','B. print()']]
...
option1 = tk.Radiobutton(frame, bg="lightgreen", variable=v1, font=('Verdana', 20),
                         command = lambda : checkAnswer(option1))
option2 = tk.Radiobutton(frame, bg="lightgreen", variable=v2, font=('Verdana', 20), 
                         command = lambda : checkAnswer(option2))
option3 = tk.Radiobutton(frame, bg="lightgreen", variable=v3, font=('Verdana', 20), 
                         command = lambda : checkAnswer(option3))
option4 = tk.Radiobutton(frame, bg="lightgreen", variable=v4, font=('Verdana', 20), 
